...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-fenix-500/50 focus:ring-offset-2 focus:ring-offset-background",
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          "border-transparent bg-secondary text-secondary-foreground hover:bg-ash-200 dark:hover:bg-ash-700",
        success:
        ...
        outline:
          "border-input text-ash-700 dark:text-ash-300",
      },
    },
    defaultVariants: {
      variant: "default",
